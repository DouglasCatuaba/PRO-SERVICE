...
import 'package:wpe_apresentacao/Formularios/formulariocadastro.page.dart';
import 'package:wpe_apresentacao/Formularios/formularioservico.page.dart';




class CadastroadPage extends StatelessWidget {
  const CadastroadPage({super.key});
              ...
              child: SizedBox.expand(
                child: TextButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of
                    (context).push(PageTransition(
                      child: const FormularioCadastro(),
